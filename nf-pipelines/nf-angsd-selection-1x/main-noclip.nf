...
// Default Parameters
params.samplesheet = "${projectDir}/inputfiles/samplesheet_noclip.csv" // sample sheet csv with columns for sample name, bam path, pop, era, and region. era is historic or modern. region matches historic and modern populations for diversity calculations. pop is not used
...
params.outdir      = "${projectDir}/results-noclip" // output directory for all results
